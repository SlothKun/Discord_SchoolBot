...
TOKEN = "Njg5MTM4ODc0NDgzODY3ODM4.Xm-k8w.P9N17sU355BtAJ2v-3_rx6LKLKM"
...
async def sondage(message, user_sended):
    try:
        ...
        channel_sondages = client.get_channel(691092710085492758)
        ...
        complete_string = f"Sondage proposé par {message.author.nick} :\n" + description.content + "\n"
...
async def on_message(message):
    ...
    if message.channel.id == 690154420050067473: # envoi/reception tests
        ...
        prof = client.get_user(122372446761254912)
        matiere = "test"
        ...
        elif message.content.lower().startswith("!eleves"):
...
TheoG     |  TheoB     |  Thibaut  |  Vivien     |
            ```""")
        elif message.content.lower().startswith("!correction"):
